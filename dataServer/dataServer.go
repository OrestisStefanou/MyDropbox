...
func handleConn(conn net.Conn) {
	...
	for {
		...
		case "createUser":
			log.Println(conn.RemoteAddr().String(), ":Requested to create a user")
		...
		case "SendFile":
			...
			log.Println(conn.RemoteAddr().String(), ":", username, ":Requested to get file:", filepathToSend)
...
func sendFileInfo(conn net.Conn, r netMsg) {
	username := r.Data
	log.Println(conn.RemoteAddr().String(), ":", username, ":Requested to get files timestamps")
